...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'http://www.wenrui.love/', // 网站地址
  ...
  ADSENSE_GOOGLE_SLOT_NATIVE:
    process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_NATIVE || '5871084178', // Google AdScene>广告>按单元广告>新建原生广告
  ADSENSE_GOOGLE_SLOT_AUTO:
    process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_AUTO || '5871084178', // Google AdScene>广告>按单元广告>新建展示广告 （自动广告）
